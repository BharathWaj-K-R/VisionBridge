...
_translate_limiter = SlidingWindowRateLimiter(limit=settings.TRANSLATE_RATE_LIMIT_PER_MINUTE)
_rate_limit = make_rate_limit_dependency(_translate_limiter)
...
@router.post("", response_model=TranslationResult, dependencies=[Depends(_rate_limit)])
def translate(
