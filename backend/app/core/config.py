...
class Settings:
    ...
    CALIBRATION_MIN_SECONDS: int = int(os.getenv("CALIBRATION_MIN_SECONDS", "300"))
    CALIBRATION_MAX_FRAMES: int = int(os.getenv("CALIBRATION_MAX_FRAMES", "256"))
    ...
    def validate_for_runtime(self) -> None:
        ...
        if self.CALIBRATION_MAX_FRAMES < 1 or self.CALIBRATION_MAX_FRAMES > self.MAX_INFERENCE_FRAMES:
            raise RuntimeError("CALIBRATION_MAX_FRAMES must be between 1 and MAX_INFERENCE_FRAMES")
